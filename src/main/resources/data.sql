...
INSERT INTO COMPANY_BANK_ACCOUNT (ID,CREATED_AT,UPDATED_AT, BANK_NAME, ACCOUNT_NUMBER, ACCOUNT_NAME, STATUS, PAYMENT_SERVICE_ID) VALUES (1, now(), now(), 'BCA', '1827883732', 'PT.Aplikasi Liburan Indonesia', 'AVAILABLE', 'BT_BCA');
...
INSERT INTO PAYMENT(ID,TRANSACTION_ID,USER_ID,PAYMENT_SERVICE_ID,FARE_AMOUNT,SERVICE_FEE_AMOUNT,DISCOUNT_AMOUNT,TOTAL_AMOUNT,PAYMENT_SERVICE_AMOUNT,IS_SPLIT_BILL,POINT_AMOUNT,REMAINING_AMOUNT,STATUS,DETAIL_TYPE,DETAIL_ID,CREATED_AT,UPDATED_AT) VALUES ('51f80e20-b573-447b-a365-040f53fb6e5b', '58b5a77b-ed7d-4eed-a302-e0f28d989f67',5,'BT_BCA', 98500, 35, 0, 98535, 98535, false, 0, 98535, 'WAITING_PAYMENT', 'bankTransfer', 'ef9abf24-a4bd-45a6-9191-293d6ac61c0b', now(), now());


INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (1, now(), now(), 'payment_intruction.1.description', 'ATM BCA', 1, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (2, now(), now(), 'payment_intruction.2.description', 'ATM BCA', 2, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (3, now(), now(), 'payment_intruction.3.description', 'ATM BCA', 3, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (4, now(), now(), 'payment_intruction.4.description', 'ATM BCA', 4, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (5, now(), now(), 'payment_intruction.5.description', 'ATM BCA', 5, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (6, now(), now(), 'payment_intruction.6.description', 'm-BCA (BCA Mobile)', 1, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (7, now(), now(), 'payment_intruction.7.description', 'm-BCA (BCA Mobile)', 2, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (8, now(), now(), 'payment_intruction.8.description', 'm-BCA (BCA Mobile)', 3, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (9, now(), now(), 'payment_intruction.9.description', 'm-BCA (BCA Mobile)', 4, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (10, now(), now(), 'payment_intruction.10.description', 'm-BCA (BCA Mobile)', 5, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (11, now(), now(), 'payment_intruction.11.description', 'Internet Banking BCA', 1, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (12, now(), now(), 'payment_intruction.12.description', 'Internet Banking BCA', 2, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (13, now(), now(), 'payment_intruction.13.description', 'Internet Banking BCA', 3, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (14, now(), now(), 'payment_intruction.14.description', 'Internet Banking BCA', 4, 'BT_BCA');
INSERT INTO PAYMENT_INSTRUCTION(ID, CREATED_AT, UPDATED_AT, INDEX_DESCRIPTION, CATEGORY, SORT, PAYMENT_SERVICE_ID) VALUES (15, now(), now(), 'payment_intruction.15.description', 'Internet Banking BCA', 5, 'BT_BCA');